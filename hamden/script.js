$(document).ready(function() {
  ...
  const layers = [
    {name: 'pre1900s', path: 'geojson/pre1900s.geojson', layer: null},
        ...
        layers[i].layer = L.geoJson(data, {
          ...
          onEachFeature: function(feature, layer) {
            ...
            layer.bindPopup(feature.properties.siteaddres
              + '<br>Type ' + feature.properties.scrcog_lu
  ...
  $.getJSON("geojson/hamden.geojson", function (data) {
    L.geoJson(data, {
      interactive: false,
